package com.sky.skymusic.common.util;
...
public class AliyunOSSUtils {
     ...
     * @Author zhaoweifeng
     */
    public String aliyunUpload(String objectName,
        ...
        // 设置URL过期时间为hours小时。
//        Date expiration = new Date(System.currentTimeMillis() + 3600L * 1000 * 300 * hours);
        Date date = new Date();
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.add(Calendar.YEAR, 10);
        //返回url地址
        String url = ossClient.generatePresignedUrl(bucketName, objectName, cal.getTime()).toString();
     ...
     * @Author zhaoweifeng
     */
    public void aliyunDownFile(String objectName,
     ...
     * @Author zhaoweifeng
     */
    public void aliyunDeleteFile(String objectName) {
        // 创建OSSClient实例。
        OSS ossClient = new OSSClientBuilder().build(endPoint, accessKeyId, accessKeySecret);
